      ...
      .map((segment) => {
        if (segment[0] === "NSECM" || segment[0] === "BSECM") {
          return {
            ...
            ISIN: segment[15],
            Numerator: segment[16],
            Denominator: segment[17],
            descriptionTwo: segment[18],
          ...
          if (segment[5].substring(0, 3) === "FUT") {
            return {
              ...
              descriptionTwo: segment.length > 20 ? segment[20] : "0.0",
              strikePrice: "0.0",
              optionType: "0.0",
              // DisplayName: segment.length > 17
              //     ? segment[17]
              //     : '0.0',
              ISIN: "0.0",
              // Numerator: segment.length > 18
              //     ? segment[18]
              //     : '0.0',
              // Denominator: segment.length > 19
              //     ? segment[19]
              //     : '0.0',
            };
          } else {
            return {
              ...
              descriptionTwo: segment.length > 22 ? segment[22] : "0.0",
            };
          }
        } else {
          if (segment[5].substring(0, 3) === "OPT") {
            return {
              ...
              underlyingIndexName: segment.length > 15 ? segment[15] : "0.0",
              contractExpiration: segment.length > 16 ? segment[16] : "0.0",
              strikePrice: segment[17],
              optionType: segment[18],
              DisplayName: segment.length > 19 ? segment[19] : "0.0",
              ISIN: "0.0",
              Numerator: segment.length > 20 ? segment[20] : "0.0",
              Denominator: segment.length > 21 ? segment[21] : "0.0",
              descriptionTwo: segment[22],
            };
          } else {
            return {
              exchangeSegment: segment[0],
